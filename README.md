...
[![Maven](https://img.shields.io/badge/maven-v3.1.8-green.svg)](https://github.com/sendbird/SendBird-SDK-Android/tree/master/com/sendbird/sdk/sendbird-android-sdk/3.1.8)
...
dependencies {
    ...
    implementation 'com.sendbird.sdk:sendbird-android-sdk:3.1.8'
    ...
}
```
