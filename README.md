...
[![Maven](https://img.shields.io/badge/maven-v3.0.156-green.svg)](https://github.com/sendbird/SendBird-SDK-Android/tree/master/com/sendbird/sdk/sendbird-android-sdk/3.0.156)
...
dependencies {
    implementation 'com.sendbird.sdk:sendbird-android-sdk:3.0.156'
}
```
