...
[![Maven](https://img.shields.io/badge/maven-v3.0.3-green.svg)](https://github.com/smilefam/SendBird-SDK-Android/tree/master/com/sendbird/sdk/sendbird-android-sdk/3.0.3)
...
dependencies {
    compile 'com.sendbird.sdk:sendbird-android-sdk:3.0.3'
}
```
