...
[![Maven](https://img.shields.io/badge/maven-v3.0.113-green.svg)](https://github.com/sendbird/SendBird-SDK-Android/tree/master/com/sendbird/sdk/sendbird-android-sdk/3.0.113)
...
dependencies {
    implementation 'com.sendbird.sdk:sendbird-android-sdk:3.0.113'
}
```

TLS1.3 support is included in version 3.0.113 of the SendBird Android SDK.
